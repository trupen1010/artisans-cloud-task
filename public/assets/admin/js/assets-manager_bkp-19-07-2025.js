        ...
        pond = FilePond.create(inputElement, {
            ...
            onaddfile: (error, file) => {
                ...
                if (fileSizeMB >= maxSize) {
                    const readableMax = formatSizeUnit(maxSize);
                    const readableActual = formatSizeUnit(fileSizeMB);
                    // show_notify(`The file size of ${fileName} exceeds the limit of ${maxSize} MB.`, 'fail');
                    show_notify(`The file size of ${fileName} exceeds the limit of ${readableMax}.`, 'fail');
                    return false;
                }
            },
        });
