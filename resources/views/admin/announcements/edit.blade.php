                        ...
                        <div class="row g-3">
                            <div class="col-lg-12">
                                <div class="form-floating">
                                    <input name="title" type="text" class="form-control" id="title" placeholder="Enter Title" value="{{ old('title', $announcement->title) }}" />
                            ...
                            <div class="col-lg-12">
                                <div class="form-floating">
                                    <textarea name="body" class="form-control" id="body" placeholder="Enter Description" style="height: 150px">{{ old('body', $announcement->body) }}</textarea>
